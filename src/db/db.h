...
public:
    ...
    void drop_table(const SDB::Type::TableProperty &table_property);
    ...
    void update(const std::string &table_name, const std::string &pred_col_name, SDB::Type::BVFunc predicate,
                    const std::string &op_col_name, SDB::Type::VVFunc op);
    DB::TupleLst find(const std::string &table_name, const std::string &col_name, const SDB::Type::Value &value);
    DB::TupleLst
    find(const std::string &table_name, const std::string &col_name, std::function<bool(DB::Value)> predicate);
